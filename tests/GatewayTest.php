...
class GatewayTest extends GatewayTestCase
{
    ...
    public function testAuthorize()
    {
        ...
        $this->assertInstanceOf('\Omnipay\Epayco\Message\CreditCardRequest', $request);
    ...
    public function testCompleteAuthorize()
    {
        ...
        $this->assertInstanceOf('\Omnipay\Epayco\Message\TransactionReferenceRequest', $request);
    ...
    public function testUpdateCard()
    {
        ...
        $this->assertInstanceOf('\Omnipay\Epayco\Message\CardReferenceRequest', $request);
